    ...
    <div className="min-h-screen w-full">
      ...
      <section className="relative flex min-h-[60vh] items-center">
        ...
        <div
          ...
          style={{ backgroundImage: "url('/studio-film.webp')" }}
        >
          <div className="absolute inset-0 bg-linear-to-b from-background/30 via-background/50 to-background" />
        </div>
      ...
      <section className="px-4 py-16 md:px-6">
        <div className="container mx-auto max-w-6xl">
          <h2 className="mb-4 text-center font-bold text-3xl md:text-4xl">Pricing</h2>
            ...
            {services.map((service) => (
              ...
              >
                <CardHeader className="pb-2 text-center">
                  <div className="mx-auto mb-3 text-primary">{service.icon}</div>
      ...
      <section className="px-4 py-16 md:px-6">
        <div className="container mx-auto max-w-4xl">
          <h2 className="mb-8 text-center font-bold text-3xl md:text-4xl">Past Work</h2>
      ...
      <section id="contact" className="bg-muted/30 px-4 py-16 md:px-6">
        <div className="container mx-auto max-w-xl">
          <h2 className="mb-4 text-center font-bold text-3xl md:text-4xl">Let's Work Together</h2>
