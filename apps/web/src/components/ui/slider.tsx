  ...
  return (
    ...
    >
      <SliderPrimitive.Track
        ...
        className={cn(
          // oxlint-disable-next-line lukeroes-tailwind/prefer-size-utility -- h-1.5 and w-1.5 are behind different orientation modifiers
      ...
      {Array.from({ length: _values.length }, (_, index) => (
        <SliderPrimitive.Thumb
          ...
          // biome-ignore lint/suspicious/noArrayIndexKey: Dynamic thumbs generated from array length
          key={index}
