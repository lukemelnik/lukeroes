  ...
  return (
    <section className="w-full bg-muted/30 px-4 py-16 md:px-6">
      <div className="container mx-auto">
        <div className="mb-8">
          <h2 className="mb-2 font-bold text-3xl tracking-tight">Videos</h2>
          <p className="text-muted-foreground">Watch music videos, live performances, and more</p>
        </div>
                  ...
                  <CardContent className="p-0">
                    <div className="relative aspect-video">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center bg-black/60 opacity-0 transition-opacity group-hover:opacity-100">
                        <div className="flex size-16 items-center justify-center rounded-full bg-primary transition-transform hover:scale-110">
                          <Play className="ml-1 size-8 fill-primary-foreground text-primary-foreground" />
                        </div>
                      </div>
                    </div>
                    <div className="space-y-2 p-4">
                      <h3 className="line-clamp-2 font-semibold text-lg">{video.title}</h3>
                      {video.publishedAt && (
